...
# 2. FederatedEMNIST
cd ./FedML/data/FederatedEMNIST
sh download_federatedEMNIST.sh
cd ../../../

# 3. shakespeare
cd ./FedML/data/shakespeare
sh download_shakespeare.sh
cd ../../../


# 4. fed_shakespeare
cd ./FedML/data/fed_shakespeare
sh download_shakespeare.sh
cd ../../../

# 5. fed_cifar100
cd ./FedML/data/fed_cifar100
sh download_fedcifar100.sh
cd ../../../

# 6. stackoverflow
cd ./FedML/data/stackoverflow
...
# 8. CIFAR100
cd ./FedML/data/cifar100
sh download_cifar100.sh
cd ../../../

# 9. CINIC10
cd ./FedML/data/cinic10
