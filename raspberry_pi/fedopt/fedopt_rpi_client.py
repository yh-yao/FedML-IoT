...
from FedML.fedml_api.distributed.fedopt.FedOptTrainer import FedOptTrainer
from FedML.fedml_api.distributed.fedopt.FedOptClientManager import FedOptClientManager
...
def register(args, uuid):
    ...
    class Args:
        def __init__(self):
            ...
            self.clip = 0.5 #temperal use, du guo presentation
...
if __name__ == '__main__':
    ...
    client_manager = FedOptClientManager(args, trainer, rank=client_ID, size=size, backend="MQTT")
    client_manager.run()
